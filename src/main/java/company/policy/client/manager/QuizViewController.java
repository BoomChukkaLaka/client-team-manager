...
public class QuizViewController implements ChatClient {
        ...
        displayTreeBtn.setOnAction(e -> {
            try {
                ...
                if (tree != null) {
                    ...
                    String binaryTreeString = btp.print();

                    treeViewTArea.setText(binaryTreeString); // Save to file - binaryTreeString
                }
    ...
    /*
    // Save file - binary tree - btnExit_2 - rename btnSave?
    @FXML
    private void writeFile(String filename) {
        String fileName = System.getProperty("user.dir") + File.separator + "binarytree.txt";
        File file = new File(fileName);

        // From Binary Tree printer
        BinaryTreePrinter btp = new BinaryTreePrinter(tree.root);
        String binaryTreeString = btp.print();
        ...
        // Write the picture fields to the file
        try ( BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            writer.append(binaryTreeString);
